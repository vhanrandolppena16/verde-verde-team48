...
// Import other components
  ...
  import { sensor_db } from "../../../../../firebase_database/firebase"; // Import realtime database from Firebase Config
    ...
    onValue(readingsRef, (snapshot) => {
      ...
      if (snapshot.exists()) {
        ...
        if (latestReading) {
          ...
          setPredicted_days(latestReading.predicted_days ?? null); // use await fetch.axios(api/predict/)
        }
      }
    });
